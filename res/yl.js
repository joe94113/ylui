window.YL = {
  info: {
    ...
    copyrightDetail:
      "YLUI已授权本产品使用。YLUI禁止任何未经作者授权的使用、修改、二次发布，包括从本产品中剥离YLUI独立使用等侵权行为，违者将追究法律责任。",
    otherStatements: "",
  },
  data: {},
  lang: function (key) {
    return YL.static.languages[YL.static.lang]
      ? YL.static.languages[YL.static.lang][key]
      : "";
  },
  readyStack: [],
  loadStack: [],
  ...
  init: function (data) {
    ...
    data = data
      ? data
      : localStorage.getItem(YL.static.localStorageName)
      ? JSON.parse(localStorage.getItem(YL.static.localStorageName))
      : this._baseData();
    data = YL.format(data);
    $("#loading").remove();
    YL.render(data);
  ...
  msg: function (title, content) {
    ...
    var msgPreID = this.vue.setWithID(
      this.vue.msgPres,
      Yuri2.jsonMerge(options, {
        index: j,
      }),
      "msgPre-"
    );
  ...
  uninstall: function (appId) {
    if (Yuri2.inArray(YL.static.lockedApps, appId)) {
      this.util.simpleMsg(
        YL.lang("UninstallFailed") + YL.lang("AppLockedCanNotChange")
      );
      return false;
    }
  ...
  addApp: function (appId, data) {
    if (Yuri2.inArray(YL.static.lockedApps, appId)) {
      this.util.simpleMsg(
        YL.lang("AddAppFailed") + YL.lang("AppLockedCanNotChange")
      );
      return false;
    }
  ...
  loadRes: function () {
    ...
    document.getElementById("loading-software-name").innerHTML =
      YL.static.softwareName;
    document.getElementById("loading-lang-init").innerHTML = YL.lang(
      "LoadingInitializing"
    );
    document.getElementById("loading-powered-by").innerHTML =
      YL.lang("LoadingPoweredBy");
    ...
    var itvLoading = setInterval(function () {
      ...
      document.getElementById("on-load-file-name").innerHTML = YL.static.debug
        ? onLoading
        : YL.lang("LoadingStandby");
      ...
      if (flagFifty)
        document.getElementById("loading-left").style.transform =
          "rotate(" + degLeft + "deg)";
      document.getElementById("loading-right").style.transform =
        "rotate(" + degRight + "deg)";
    }, 200);
    ...
    //jq
    YL.util.loadScript(
      pathRes + "/components/jquery-2.2.4.min.js",
      function () {
        ...
        //contextMenu
        YL.util.loadScript(
          pathRes + "/components/contextMenu/contextMenu.js" + versionTail,
          function () {
        ...
        YL.util.loadStyle(
          pathRes + "/components/contextMenu/contextMenu.css" + versionTail,
          function () {
        ...
        YL.util.loadScript(
          pathRes + "/components/jquery.nicescroll.min.js",
          function () {
        ...
        YL.util.loadScript(
          pathRes + "/components/layer-v3.0.3/layer/layer.full.js",
          function () {
    ...
    YL.util.loadStyle(
      pathRes + "/css/yl-layer-skin.css" + versionTail,
      function () {
    ...
    YL.util.loadStyle(
      pathRes +
        "/components/layer-v3.0.3/layer/skin/default/layer.css" +
        versionTail,
      function () {
        onLoading = "layer.css";
        counterLoad++;
    ...
    YL.util.loadStyle(
      pathRes + "/components/animate.css" + versionTail,
      function () {
    ...
    YL.util.loadStyle(
      pathRes + "/components/font-awesome-4.7.0/css/font-awesome.min.css",
      function () {
        onLoading = "font-awesome.min.css";
        counterLoad++;
      }
    );
    YL.util.loadPrefetch(
      pathRes +
        "/components/font-awesome-4.7.0/fonts/fontawesome-webfont.woff2?v=4.7.0",
      function () {
    ...
    YL.util.loadPrefetch(
      pathRes + "/apps/element-ui/fonts/element-icons.woff?t=1510834658947",
      function () {
    ...
    YL.util.loadScript(pathRes + "/components/vue.min.js", function () {
      ...
      YL.util.loadScript(
        pathRes + "/components/vue-grid-layout-2.1.11.min.js",
        function () {
      ...
      YL.util.loadScript(
        pathRes + "/js/yl-vue-component-icon.js" + versionTail,
        function () {
      ...
      YL.util.loadScript(
        pathRes + "/js/yl-vue-components.js" + versionTail,
        function () {
    ...
    YL.util.loadScript(
      pathRes + "/components/calendar/script.js" + versionTail,
      function () {
    ...
    YL.util.loadStyle(
      pathRes + "/components/calendar/style.css" + versionTail,
      function () {
  ...
  util: {
    ...
    getStrFa: function (content, withSpace) {
      ...
      return (
        "<i class='fa fa-fw fa-" + content + "'></i>" + (withSpace ? " " : "")
      );
    },
  ...
  child: {
    ...
    setAppBadge: function (data, id) {
      var v = YL.vue;
      var app = Yuri2.isArray(data)
        ? v.apps[data[0]]
        : YL.util.getAppByWinId(id);
      ...
      YL.util.simpleConfirm(YL.lang("ChildMethodSetupConfirm"), function () {
        ...
        if (data.shortcuts) {
          data.shortcuts.forEach(function (t) {
            if (YL.util.hasApp(t)) YL.addShortcut(t);
          });
        }
        if (data.sidebar) {
          data.sidebar.forEach(function (t) {
            if (YL.util.hasApp(t)) YL.addSidebarBtn(t);
          });
        }
        if (data.tiles) {
          data.tiles.forEach(function (t) {
            if (YL.util.hasApp(t)) YL.addTile(t);
          });
        }
        if (data.menu) {
          var hasError = false;
        ...
        var win = v.wins[id];
        YL.msg(
          YL.lang("ChildMethodSetupSuccessMsgTitle"),
          YL.lang("ChildMethodSetupSuccessMsgContent") + win.url
        );
      });
    },
    uninstall: function (data, id) {
      ...
      YL.util.simpleConfirm(
        YL.lang("ChildMethodUninstallConfirm"),
        function () {
          var list = [];
          ...
          var win = v.wins[id];
          YL.msg(
            YL.lang("ChildMethodUninstallSuccessMsgTitle"),
            YL.lang("ChildMethodUninstallSuccessMsgContent") + win.url
          );
        }
      );
    },
...
YL.util.onloadSafe(function () {
  YL.util.loadScript("./configs.js", function () {
    ...
    YL.util.loadContentFromUrl(
      "./langs/" + YL.static.lang + ".json",
      "GET",
      function (err, text) {
        if (!err) {
